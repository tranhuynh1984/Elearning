...
{
    public class DMCTVSearchResponseData : UpdateTimeResponseData
    {
        ...
        public string TenDTCTV { get; set; }
        ...
        public List<LogContractCTVResponseData> LogContractCTVResponseDatas { get; set; }
    }
}