...
using model = Elearning.Database.Models;
...
namespace Elearning.Database
{
    public class Context : DbContext
    {
        ...
        public DbSet<Elearning.Database.Models.Phase2.Process> Process { get; set; }
        public DbSet<Elearning.Database.Models.Phase2.ProcessStep> ProcessStep { get; set; }
        public DbSet<Elearning.Database.Models.Phase2.ApprovedFlow> ApprovedFlow { get; set; }
        public DbSet<Elearning.Database.Models.Phase2.ApprovedFlowDetail> ApprovedFlowDetail { get; set; }
        public DbSet<Elearning.Database.Models.Phase2.TBL_LOGCTVGROUP> TBL_LOGCTVGROUP { get; set; }
